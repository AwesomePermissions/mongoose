...
class MongooseAwesomePermissions {
    ...
    async #hasViewPermissionToItem(ctx, doc, {actionsType = "or"} = {}) {
        return this.#hasPermissionToItem(ctx, doc, {actions: ["view"], actionsType});
    }
    async #hasCreatePermissionToItem(ctx, doc, {actionsType = "or"} = {}) {
        return this.#hasPermissionToItem(ctx, doc, {actions: ["create"], actionsType});
    }
    async #hasUpdatePermissionToItem(ctx, doc, {actionsType = "or"} = {}) {
        return this.#hasPermissionToItem(ctx, doc, {actions: ["update"], actionsType});
    }
    async #hasDeletePermissionToItem(ctx, doc, {actionsType = "or"} = {}) {
        return this.#hasPermissionToItem(ctx, doc, {actions: ["delete"], actionsType});
    }
    async #hasAdminPermissionToItem(ctx, doc, {actionsType = "or"} = {}) {
        return this.#hasPermissionToItem(ctx, doc, {actions: ["admin"], actionsType});
    }
    ...
    loadSchema() {
        return (schema, options) => {
            ...
            schema.methods.addAdminPermissionsToItems = function () {return _this.#addAdminPermissionsToItems.bind(_this)(this, ...arguments)}
